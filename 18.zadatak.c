...
#include<string.h>
#include<stdlib.h>
/*Napisati funkciju koja za odredenu recenicu vraca koliko je broj samoglasnika, ispisite broj samoglasnika koji imaju malo slovo.*/
int main() {
	char s[30];
	int i;
	int brojac = 0;
...
malo slovo u recenici. Brojacem spremamo broj samoglasnika u nasoj recenici.*/